...
//     fetch(`http://localhost:7000/country?language=en${countryParam}&page=${page}&pageSize=${pageSize}`, {
//       headers: {
...
function CountryNews() {
  ...
  if (!isAuthenticated) {
    // Return early and prevent rendering the rest of the component if the user is not authenticated
    return null;  // This prevents rendering the rest of the content while redirecting
  }
